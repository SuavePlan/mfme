...
//---------------------------------------------------------------------------
__fastcall TGRDotAlpha::TGRDotAlpha(int ANumber, int AX, int AY, int AHeight, int AWidth, TImage32 * Adest)
    : TGRBase(ANumber,"TGRDotAlpha",AX,AY,AHeight,AWidth,Adest)
{
  FSizeX = 2;
  FSizeY = 2;
  FDigitSpacing = 2;
...
//---------------------------------------------------------------------------
__fastcall TGRDotAlpha::~TGRDotAlpha()
{
  delete Src;
  delete chars;
}
//---------------------------------------------------------------------------
void __fastcall TGRDotAlpha::SetDisplay(int *ptr)
{
...
//---------------------------------------------------------------------------
void __fastcall TGRDotAlpha::SetChar(Byte *ptr)
{
int chr   = ptr[1]; // - 1;  ??
...
//---------------------------------------------------------------------------
void __fastcall TGRDotAlpha::SetSizeX(int ASize)
{
  if ( ASize != FSizeX ) {
    FSizeX = ASize;
    Init();
...
//---------------------------------------------------------------------------
void __fastcall TGRDotAlpha::SetSizeY(int ASize)
{
  if ( ASize != FSizeY ) {
    FSizeY = ASize;
    Init();
...
//---------------------------------------------------------------------------
void __fastcall TGRDotAlpha::SetIntensity(int AIntensity)
{
...
//---------------------------------------------------------------------------
void __fastcall TGRDotAlpha::SetColour(TColor AColour)
{
  if ( AColour != FColour ) {
    FColour = AColour;
    Init();
...
//---------------------------------------------------------------------------
void __fastcall TGRDotAlpha::Render(void)
{
int i;
int chr;
int index;
...
//---------------------------------------------------------------------------
void __fastcall TGRDotAlpha::Draw(void)
{
  Src->DrawTo(Bitmap);
  TGRBase::Draw();
}
//---------------------------------------------------------------------------
void __fastcall TGRDotAlpha::Init(void)
{
//  if ( FSize > 4 )
//    Spacing = 2;
//  else
//    Spacing = 1;
  ...
  chars->SetSize( ((FSizeX + 1) * 6) * 0x80, (FSizeY + 1) * 7);
  SetBounds(X,Y,Width,Height);
  GenerateCharSet();
}
//---------------------------------------------------------------------------
void __fastcall TGRDotAlpha::GenerateCharSet(void)
{
int i;
...
//---------------------------------------------------------------------------
void __fastcall TGRDotAlpha::GenerateChar(int i)
{
int x, y;
int xpos, ypos;
...
//---------------------------------------------------------------------------
void __fastcall TGRDotAlpha::GenerateCustomChar(int i)
{
int x, y;
int xpos, ypos;
int val;
...
//---------------------------------------------------------------------------
void __fastcall TGRDotAlpha::GetChar(TBitmap32 * ptr, int value, int pos)
{
