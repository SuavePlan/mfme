...
#define CPU_RESET        m68k_cpu.reset
...
virtual int  m68k_read_immediate_8(uint address, int cs) = 0;
virtual int  m68k_read_immediate_16(uint address, int cs) =0;
virtual int  m68k_read_immediate_32(uint address, int cs) =0;

/* Read an instruction (16-bit word immeditately after PC) */
virtual int  m68k_read_instruction(uint address, int cs) =0;

/* Write to anywhere */
virtual void m68k_write_memory_8(uint address, int value, int cs)=0;
virtual void m68k_write_memory_16(uint address, int value, int cs)=0;
virtual void m68k_write_memory_32(uint address, int value, int cs)=0;

virtual int m68k_read_memory_8(uint address, int cs)=0;
virtual int m68k_read_memory_16(uint address, int cs)=0;
virtual int m68k_read_memory_32(uint address, int cs)=0;

virtual uint m68ki_read_8  (uint address);
virtual uint m68ki_read_16 (uint address);
virtual uint m68ki_read_32 (uint address);

/* Write to memory */
virtual void m68ki_write_8 (uint address, uint value);
virtual void m68ki_write_16(uint address, uint value);
virtual void m68ki_write_32(uint address, uint value);

/* Read data immediately after the program counter */
virtual uint m68ki_read_imm_8(void);
virtual uint m68ki_read_imm_16(void);
virtual uint m68ki_read_imm_32(void);

/* Reads the next word after the program counter */
virtual uint m68ki_read_instruction(void);

/* Read data with specific function code */
virtual uint m68ki_read_8_fc  (uint address, uint fc);
virtual uint m68ki_read_16_fc (uint address, uint fc);
virtual uint m68ki_read_32_fc (uint address, uint fc);

/* Write data with specific function code */
virtual void m68ki_write_8_fc (uint address, uint fc, uint value);
virtual void m68ki_write_16_fc(uint address, uint fc, uint value);
virtual void m68ki_write_32_fc(uint address, uint fc, uint value);

/* Report port changes */
virtual void padat_updated(uint changed, uint value);
virtual void pbdat_updated(uint changed, uint value);
...
bool signal_interrupt(uint mask, uint vector);
