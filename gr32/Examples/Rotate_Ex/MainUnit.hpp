...
__published:
	Gr32_image::TImage32* Src;
	Gr32_image::TImage32* Dst;
	Gr32_rangebars::TGaugeBar* Angle;
	void __fastcall FormCreate(System::TObject* Sender);
	void __fastcall AngleChange(System::TObject* Sender);
	
public:
	void __fastcall ScaleRot(float Alpha);
public:
