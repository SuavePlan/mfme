...
// (DO NOT EDIT: machine generated header) 'GR32_Image.pas' rev: 5.00
...
{
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TPaintStageEvent)(System::TObject* Sender, Gr32::TBitmap32* Buffer
	, unsigned StageNum);
...
public:
	...
	virtual Windows::TRect __fastcall GetViewportRect(void);
...
typedef void __fastcall (__closure *TImgMouseEvent)(System::TObject* Sender, Controls::TMouseButton 
	Button, Classes::TShiftState Shift, int X, int Y, Gr32_layers::TCustomLayer* Layer);
...
public:
	...
	virtual Windows::TRect __fastcall GetBitmapRect(void);
	virtual tagSIZE __fastcall GetBitmapSize(void);
	virtual void __fastcall Invalidate(void);
	virtual void __fastcall Loaded(void);
	HIDESBASE void __fastcall PaintTo(Gr32::TBitmap32* Dest, const Windows::TRect &DestRect);
	DYNAMIC void __fastcall Resize(void);
	void __fastcall SetupBitmap(bool DoClear, Gr32::TColor32 ClearColor);
	...
	HIDESBASE virtual void __fastcall Flush(void)/* overload */;
	HIDESBASE virtual void __fastcall Flush(const Windows::TRect &SrcRect)/* overload */;
public:
	#pragma option push -w-inl
...
protected:
	...
	virtual void __fastcall BitmapResized(void);
	void __fastcall DoDrawSizeGrip(const Windows::TRect &R);
	virtual void __fastcall DoScaleChange(void);
	virtual void __fastcall DoScroll(void);
	int __fastcall GetScrollBarSize(void);
	Windows::TRect __fastcall GetSizeGripRect(void);
