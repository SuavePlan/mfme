...
{*********************************************}
// $Id: GR32_Layers.pas,v 1.5 2002/03/11 18:43:05 alex Exp $
...
uses TypInfo, GR32_Image, GR32_LowLevel;
...
begin
  DstRect := MakeRectF(GetAdjustedLocation);
...
begin
  ...
  R := MakeRectF(GetAdjustedLocation);
  with R do
  begin
    Dec(Right);
    Dec(Bottom);
